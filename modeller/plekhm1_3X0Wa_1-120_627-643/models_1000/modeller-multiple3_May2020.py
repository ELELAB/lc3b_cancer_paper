...
class MyModel(automodel):
    def select_atoms(self):
        return selection(self) - selection(self.residue_range('1:A', '120:A'), self.residue_range('128:B', '132:B'))
#rename and renumber
...
a = MyModel(env,
            ...
            knowns   = ('3x0w_chainA_no_HOH_chainize.pdb'),     # codes of the templates
